// Icon primitive — paths ported verbatim from the design source
// (copydash/components.jsx ICON_PATHS) for pixel-exact fidelity;
// these happen to match the Lucide icon set's outlines.
